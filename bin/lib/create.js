...
exports.create = function (project_path, config, options, events) {
    ...
    return exports.validatePackageName(package_name)
        ...
        // Log the given values for the project
            events.emit('log', 'Creating Cordova project for the SWT platform:');
            ...
            fs.copySync(path.join(project_template_dir, 'resources'), path.join(app_path, 'resources'));fs.copySync(path.join(ROOT, '../', '../', 'config.xml'), path.join(project_path, 'res', 'xml', 'config.xml'));
